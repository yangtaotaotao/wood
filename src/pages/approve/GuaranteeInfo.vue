        ...
        if (!res.data.success) {
          ...
          queryCarInfo({id}).then(res => {
            ...
            if (success) {
              ...
              contractInfo.boardType = woodInfo.boardType // 板材种类
              contractInfo.boardSpeci = woodInfo.boardSpeci // 规格
              contractInfo.placeOrigin = woodInfo.placeOrigin //  产地
              contractInfo.packetNumber = woodInfo.packetNumber // 包号
              contractInfo.boardLong = woodInfo.boardLong ? woodInfo.boardLong.toString() : '' // 长
              contractInfo.boardWide = woodInfo.boardWide ? woodInfo.boardWide.toString() : '' // 宽
              contractInfo.boardHigh = woodInfo.boardHigh ? woodInfo.boardHigh.toString() : '' // 高
              contractInfo.totalVolume = woodInfo.totalVolume.toString() // 总材积
              contractInfo.storeMarket = woodInfo.storeMarket // 存放市场
              contractInfo.marketContact = woodInfo.marketContact // 市场联系人
