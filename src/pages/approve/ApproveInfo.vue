<template>
  <div class="info-wrapper car-column">
    ...
    <div class="info-content">
      ...
      <div class="info car-bg-white">
        <div class="info-title">
          <car-loan-title class="title" title="汽车质押信息"></car-loan-title>
        </div>
        <div class="info-pledge">
          ...
          <div class="pledge car-row car-t-dgray car-bg-white" v-for="(item, index) in loanAutoGuarantees" :key="index" @click="toCarInfo(item)">
      ...
      <div class="info car-bg-white">
        <div class="info-title">
          <car-loan-title class="title" title="价格编辑"></car-loan-title>
        </div>
        <div class="info-pledge">
          <div class="pledge car-row car-t-gray">
            <div class="brand">品牌</div>
          ...
          <div class="pledge car-row car-t-dgray car-bg-white" v-for="(item, index) in loanAutoGuarantees" :key="index" @click="toPriceEdit(item)">
            <div class="brand">{{item.brand}}</div>
            <div class="series">{{item.carSystem}}</div>
            <div class="qualified-num">{{item.certificateNumber}}</div>
            <div class="frame-num car-row">
      ...
      <div class="info img car-bg-white">
        <div class="info-title">
          <car-loan-title class="title" title="放款同意证明书"></car-loan-title>
        </div>
      ...
      <div class="info img car-bg-white">
        ...
        <span v-if="loanAttachList.length === 0 || TypeArr.indexOf(3) === -1">
          <other-img :imgInfo="3"></other-img>
        </span>
        <div v-else class="info-img">
          <template v-for="(item, index) in loanAttachList">
            <contract-img v-if="item.attType === 3" :key="index" :imgInfo="item"></contract-img>
          </template>
        </div>
      </div>
      <div class="info img car-bg-white">
        <div class="info-title">
          <car-loan-title class="title" title="车辆质押证明"></car-loan-title>
        </div>
      ...
      <div class="info img car-bg-white">
        <div class="info-title">
          <car-loan-title class="title" title="车辆质押合同"></car-loan-title>
        </div>
          ...
          <div class="loan-person car-column" ref="unionWrap">
            ...
            <div class="person car-row car-t-dgray" v-for="(key, keyIndex) in addLength" :key="keyIndex" v-show="addLength.length">
              ...
              <div class="union-selector">
                <span class="loan-company" @click="key.flag = !key.flag">{{key.name}}</span>
                <ul v-show="key.flag">
        ...
        if (!res.data.success) {
          ...
          queryLoanDetail({loanId: id}).then(res => {
            ...
            if (success) {
              ...
              this.loanAutoGuarantees = res.data.data.loanAutoGuarantees // 价格编辑
