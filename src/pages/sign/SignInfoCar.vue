    ...
    <div class="info-content">
      ...
      <div class="info car-bg-white">
        ...
        <div class="info-pledge">
          ...
          <div class="pledge car-row car-t-dgray car-bg-white" v-for="(item, index) in loanAutoGuarantees" :key="index">
        ...
        if (!res.data.success) {
          ...
          queryLoanDetail({loanId}).then(res => {
            ...
            if (success) {
              ...
              if (this.loanAttachList.length > 0) {
                this.loanAttachList.forEach(item => {
                  if (item.attType === 1 && item.fileExt !== 'PDF' && item.fileExt !== 'DOC' && item.fileExt !== 'DOCX') {
